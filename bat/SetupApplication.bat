...
:: Android packaging
set AND_CERT_NAME="BubbleJack"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BubbleJack.p12
...
set IOS_PROVISION=cert\BubbleJack.mobileprovision
...
set APP_ID=air.BubbleJack

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BubbleJack
